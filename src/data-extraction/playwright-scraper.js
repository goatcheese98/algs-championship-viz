...
class PlaywrightScraper {
    ...
    // Placement to points conversion (same as Puppeteer version)
    ...
    async init() {
        ...
        try {
            ...
            console.log('✅ Playwright Scraper initialized with Chromium');
        } catch (error) {
            console.error('❌ Failed to initialize Playwright Scraper:', error);
            throw error;
        }
    }
    ...
    async close() {
        if (this.browser) {
            ...
            this.initialized = false;
            console.log('🎭 Playwright Scraper closed');
        }
    }
}
