  ...
  <header class="app-header" :class="headerClasses">
    <div class="header-content">
      ...
      <div class="header-right">
        ...
        >
          <svg v-if="isDarkMode" class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
.nav-toggle {
  @apply p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded-md transition-colors flex-shrink-0;
}
...
.logo-icon {
  @apply w-8 h-8 min-w-8 min-h-8 flex items-center justify-center flex-shrink-0;
  @apply bg-gradient-to-br from-red-500 to-red-600 rounded-lg;
...
.logo-icon svg {
  @apply w-4 h-4 text-white flex-shrink-0;
}
...
.subtitle-text {
  @apply text-xs text-slate-400 leading-tight font-medium;
}
